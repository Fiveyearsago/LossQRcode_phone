...
public class NotFoundAdapter extends SectionedBaseAdapter {
	...
	public NotFoundAdapter(LinkedHashMap<String, List<RemnantGoodsEntity>> map) {
		this.map = map;
	...
	public void update(LinkedHashMap<String, List<RemnantGoodsEntity>> map,boolean isEdit){
		this.map=map;
		this.isEdit=isEdit;
		if (this.map != null) {
			Iterator i = map.entrySet().iterator();
	...
	public int getCountForSection(int section) {
		...
		if(map!=null){
			if(goodNoList.size()>0){
				List<RemnantGoodsEntity> list=map.get(goodNoList.get(section));
				if(list!=null){
					return list.size();
				}
			}
	...
	public View getItemView(int section, int position, View convertView,
		...
		// TODO Auto-generated method stub
	        ...
	        if (convertView == null) {
	            ...
	            view = inflator.inflate(R.layout.wait_receive_list_item, parent,false);
	        } else {
	        	view = convertView;
	        }
	        ...
	        TextView tvInsuranceCompany=(TextView)view.findViewById(R.id.tv_insurance_company);
	        ...
	        TextView tvVehicleModel=(TextView)view.findViewById(R.id.tv_vehicle_model);
	        ...
	        final RemnantGoodsEntity remnantGood4App=map.get(goodNoList.get(section)).get(position);
